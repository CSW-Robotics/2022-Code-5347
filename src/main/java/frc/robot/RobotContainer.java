...
private final Joystick Joystick = new Joystick(Constants.joystickPort);
  ...
  */
  private RobotContainer() {
      m_sub_Drivetrain.setDefaultCommand(new RunCommand(()->m_sub_Drivetrain.DrivingNow(Joystick.getRawAxis(1)*0.8, Joystick.getRawAxis(2)*0.75), m_sub_Drivetrain));
...
*/
    ...
    //Testing Gryo
    new JoystickButton(controller, 4).whenPressed(new CmdGroup_AutoShoot(2.5));
