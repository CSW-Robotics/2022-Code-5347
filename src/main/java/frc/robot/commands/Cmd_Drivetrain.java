...
public class Cmd_Drivetrain extends CommandBase {
    ...
    public Cmd_Drivetrain(Sub_Drivetrain subsystem, DoubleSupplier ForewardSpeed, DoubleSupplier RotationSpeed) {
        m_ForwardSpeed = ForewardSpeed;
    ...
    @Override
    public void execute() {
        m_sub_Drivetrain.DrivingNow(m_ForwardSpeed.getAsDouble(), m_RotationSpeed.getAsDouble());
    }
